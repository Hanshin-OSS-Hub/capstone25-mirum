          ...
          <div className="content-inner">
            ...
            {!Array.isArray(projects) || projects.length === 0 ? (
              ...
              >
                ...
                <button className="primary-btn" onClick={() => setIsCreateProjectModalOpen(true)}>
                  + 새 프로젝트 생성
                </button>
              </div>
            ) : (
              <>
                ...
                {deletedProjects?.length > 0 && (
                  <section
                    className="project-section deleted-section"
                    style={{ marginTop: '40px', opacity: 0.8 }}
                  >
                    <div className="section-header">
                      <h2
                        style={{
                    ...
                    <div className="project-grid">
                      {deletedProjects.map((p) => (
                        ...
                        >
                          <div className="project-header">
                            <div className="project-text">
                              <h2 style={{ color: '#4b5563', textDecoration: 'line-through' }}>
                                {p.projectName}
                              </h2>
                          ...
                          <div
                            ...
                            style={{ marginTop: '12px', color: '#9ca3af' }}
                          >
                            <span>삭제일: {p.updatedDate?.slice(0, 10) || '-'}</span>
                          </div>
                        </div>
                      ))}
                    </div>
