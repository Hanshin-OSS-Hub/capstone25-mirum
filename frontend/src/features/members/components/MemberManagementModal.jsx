...
import { UserType } from '@/types/unifiedUser.js';
...
/**
 * @param {Object} props
 * @param {import('@/types/unifiedUser.js').UnifiedUser[]} props.members - 멤버 목록 (타입 힌트 적용!)
 */
  ...
  const handleDeleteMember = (member) => {
    ...
    let alertMessage =
      member.username === myUsername
        ? '정말로 탈퇴하시겠습니까?'
        : `정말로 ${member.nickname} 님을 추방하시겠습니까?`;
        ...
        >
          ...
          >
            ...
            <button
              disabled={!canInvite}
              style={{
                backgroundColor: canInvite ? '#3b82f6' : '#9ca3af',
                width: '20%',
                padding: '10px',
                marginBottom: '16px',
                color: '#fff',
                          ...
                          {isMenuOpen && openMenuId === user.username && (
                            ...
                            >
                              ...
                              >
                                ...
                                <li
                                  style={{ cursor: 'pointer', padding: '10px 12px 8px 12px' }}
                                  onClick={(event) => {
                                    event.stopPropagation();
                                    setIsMenuOpen(false);
